$(function () {
        ...
        success: function (result) {
            ...
            if (data) {
                for (var i = 0; i < data.length; i++) {
                    Echart1DataName.push(data[i].id);    //挨个取出类别并填入类别数组
                }
                for (var i = 0; i < data.length; i++) {
                    Echart1DataNum.push(data[i].rate);    //挨个取出销量并填入销量数组
                }
            }
        },
        error: function () {
    ...
    function echart_1() {
        ...
        var xAxisData = Echart1DataName;
        // var legendData = ['3月'];
        var title = "卫星利用率"; //标题
        var serieData = [];
        var metaDate = Echart1DataNum;
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (data) {
                for (var i = 0; i < data.length; i++) {
                    var pie = {};
                    Echart2DataName.push(data[i].id);    //挨个取出类别并填入类别数组
                    Echart2DataNum.push(data[i].time);    //挨个取出销量并填入销量数组
                    // pie.value = data[i].num;
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (data) {
                for (var i = 0; i < data.length; i++) {
                    var pie = {};
                    Echart3DataName.push(data[i].id);    //挨个取出类别并填入类别数组
                    Echart3DataNum.push(data[i].number);    //挨个取出销量并填入销量数组
                }
            }
        },
        error: function () {
